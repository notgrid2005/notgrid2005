...
```yaml
name: Harshith Venigalla
role: Software Development Engineer @ InMobi
education: B.Tech in Computer Science, IIT Gandhinagar (Class of '26)
...
currently_working_on: Multi-Agent AI Systems & Scalable Backend Services
...
- - Education: IIT Gandhinagar - CPI 8.22/10
  - - Achievements: JEE Advanced AIR with 99.76 percentile, 3x Dean's List
    - - Learning: Advanced ML, System Design, Cloud Architecture
      - - Ask me about: Python, AI/ML, Full-Stack Development, DSA
        - - Reach me: [LinkedIn](https://www.linkedin.com/in/harshith-venigalla-b0b004259/)
